...
var header_content =["All","MX Player","Sell","Best Sellers","Today's Deals","Mobiles","Electronics","Home & Kitchen","CustomerService","Prime","Amazon Pay","New Releases","Fashion","Car & Motorbike","Computers"]
...
function renderPagination() {
    ...
    for (let page = 1; page <= totalPages; page++) {
        ...
        // li.classList.add(page === currentPage ? 'active' : ''); // Add 'active' class to the current page
        // li.innerHTML = `${page}`;
        ...
        // Add event listener to change page when a link is clicked
        ...
        li.appendChild(a);
        // li.addEventListener(goToPage(page));
...
function goToPage(page) {
    ...
    currentPage = page;
    renderContent();   // Render the content for the new page
    renderPagination(); // Re-render the pagination controls
}
